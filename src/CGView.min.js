...
$jscomp.arrayFromArguments=function(d){for(var b=[],a=0;a<d.length;a++)b.push(d[a]);return b};$jscomp.inherits=function(d,b){function a(){}a.prototype=b.prototype;d.prototype=new a;d.prototype.constructor=d;for(var c in b)if($jscomp.global.Object.defineProperties){var g=$jscomp.global.Object.getOwnPropertyDescriptor(b,c);void 0!==g&&$jscomp.global.Object.defineProperty(d,c,g)}else d[c]=b[c]};var CGView={version:"0.1"};void 0===window.CGV&&(window.CGV=CGView);
...
c.dividers.slot);this.layout=new d.Layout(this,c.layout);this.menu=new d.Menu(this);this.help=new d.Help(this);this.annotation=new d.Annotation(this,c.annotation);this.ruler=new d.Ruler(this,c.ruler);this.highlighter=new d.Highlighter(this,c.highlighter);this.debug=d.defaultFor(c.debug,!1)};b.prototype.resize=function(a,c,g,b){this._width=a||this.width;this._height=c||this.height;this._wrapper.style("width",this.width+"px").style("height",this.height+"px");this.canvas.resize(this.width,this.height);
...
a?"map":a)};b.prototype.flash=function(a){this.messenger.flash(a)};b.prototype.maxZoomedRadius=function(){return 1*this.minDimension};b.prototype.fillBackground=function(){this.clear("background")};b.prototype.drawFull=function(){this.layout.drawFull()};b.prototype.drawFast=function(){this.layout.drawFast()};b.prototype.drawExport=function(){this.layout.drawExport()};b.prototype.draw=function(a){this.layout.draw(a)};b.prototype.findFeatureTypeByName=function(a){return this._featureTypes.find(function(c){return c.name.toLowerCase()==
a.toLowerCase()})};b.prototype.findFeatureTypeOrCreate=function(a,c){c=void 0===c?"arc":c;var g=this.findFeatureTypeByName(a);g||(g=new d.FeatureType(this,{name:a,decoration:c}));return g};b.prototype.refreshCaptions=function(){for(var a=0,c=this._captions.length;a<c;a++)this._captions[a].refresh();this.legend.refresh()};b.prototype.moveTo=function(a,c){c=void 0===c?1E3:c;var g=this,b=this.scale.x.domain(),e=this.scale.y.domain(),h=Math.abs(b[1]-b[0])/2,k=Math.abs(e[1]-e[0])/2,l=d.pixel(this.backbone.zoomedRadius),
m=this.scale.bp(a),n=l*Math.cos(m),l=-l*Math.sin(m),p=[b[0],b[1],e[0],e[1]],q=[n-h,n+h,l+k,l-k];d3.select(this.canvas.node).transition().duration(c).tween("move",function(){var a=d3.interpolateArray(p,q);return function(c){g.scale.x.domain([a(c)[0],a(c)[1]]);g.scale.y.domain([a(c)[2],a(c)[3]]);g.drawFast()}}).on("end",function(){g.drawFull()})};b.prototype.getCurrentBp=function(){var a=this.scale.x.domain(),c=this.scale.y.domain();return this.canvas.bpForPoint({x:(a[1]-a[0])/2+a[0],y:(c[1]-c[0])/
2+c[0]})};b.prototype.moveCaption=function(a,c){this._captions.move(a,c);this.refreshCaptions()};b.prototype.on=function(a,c){this.events.on(a,c)};b.prototype.off=function(a,c){this.events.off(a,c)};b.prototype.trigger=function(a,c){this.events.trigger(a,c)};Object.defineProperties(b.prototype,{width:{configurable:!0,enumerable:!0,get:function(){return this._width},set:function(a){this.resize(a)}},height:{configurable:!0,enumerable:!0,get:function(){return this._height},set:function(a){this.resize(null,
...
this.containerId+"-color-picker");this._colorPicker=new d.ColorPicker(a)}return this._colorPicker}},debug:{configurable:!0,enumerable:!0,get:function(){return this._debug},set:function(a){a?(!0===a&&(a={},a.sections=b.debug_sections),this._debug=new d.Debug(a)):this._debug=void 0}},sequence:{configurable:!0,enumerable:!0,get:function(){return this._sequence}}});Object.defineProperties(b,{debug_sections:{configurable:!0,enumerable:!0,get:function(){return["time","zoom","position","n"]}}});d.Viewer=
b})(CGView);
(function(d){cgvID=0;var b=function(a,c,g){c=void 0===c?{}:c;g=void 0===g?{}:g;this._viewer=a;this.meta=d.merge(c.meta,g);this.visible=d.defaultFor(c.visible,!0);this._cgvID="cgv-id-"+cgvID++};b.prototype.toString=function(){return"CGObject"};Object.defineProperties(b.prototype,{cgvID:{configurable:!0,enumerable:!0,get:function(){return this._cgvID}},viewer:{configurable:!0,enumerable:!0,get:function(){return this._viewer}},canvas:{configurable:!0,enumerable:!0,get:function(){return this.viewer.canvas}},sequence:{configurable:!0,
enumerable:!0,get:function(){return this.viewer.sequence}},visible:{configurable:!0,enumerable:!0,get:function(){return this._visible},set:function(a){this._visible=a}},meta:{configurable:!0,enumerable:!0,get:function(){return this._meta},set:function(a){this._meta=a}}});d.CGObject=b})(CGView);
(function(d){var b=function(a,c,g){c=void 0===c?{}:c;g=void 0===g?{}:g;d.CGObject.call(this,a,c,g);this._labels=new d.CGArray;this.font=d.defaultFor(c.font,"SansSerif, plain, 12");this.labelLineLength=d.defaultFor(c.labelLineLength,20);this._labelLineMargin=d.pixel(10);this._labelLineWidth=d.pixel(1);this.refresh();this._visibleLabels=new d.CGArray;this.color=c.color};$jscomp.inherits(b,d.CGObject);b.prototype.toString=function(){return"Annotation"};b.prototype.labels=function(a){return this._labels.get(a)};
b.prototype.addLabel=function(a){this._labels.push(a)};b.prototype.removeLabel=function(a){this._labels=this._labels.remove(a);this.refresh()};b.prototype.refresh=function(){this._labelsNCList=new d.NCList(this._labels,{circularLength:this.sequence.length})};b.prototype.refreshLabelWidths=function(){for(var a=this._labels.map(function(a){return a.font.css}),c=this._labels.map(function(a){return a.name}),a=d.Font.calculateWidths(this.canvas.context("map"),a,c),c=0,g=this._labels.length;c<g;c++)this._labels[c].width=
a[c]};b.prototype._calculatePositions=function(a){a=a||this._labels;for(var c=this._visibleRange,g,b,d,h,k=this.sequence,l=0,m=a.length;l<m;l++)g=a[l],b=g.feature,d=c.contains(b.start),h=c.contains(b.stop),d&&h?g.bp=b.start+b.length/2:d?g.bp=b.range.getStartPlus(k.lengthOfRange(b.start,c.stop)/2):h?g.bp=b.range.getStopPlus(-k.lengthOfRange(c.start,b.stop)/2):(d=k.lengthOfRange(c.stop,b.stop),b=k.lengthOfRange(b.start,c.start),g.bp=d/(d+b)*c.length+c.start)};b.prototype._calculateLabelRects=function(a){a=
a||this._labels;for(var c=this.canvas,g=c.scale,b,e,h,k=this._outerRadius+this._labelLineMargin,l=0,m=a.length;l<m;l++)b=a[l],h=b.bp,e=g.bp(h),c.pointFor(h,k),h=c.pointFor(h,k+this.labelLineLength),b.lineAttachment=d.clockPositionForAngle(e+Math.PI),e=d.rectOriginForAttachementPoint(h,b.lineAttachment,b.width,b.height),b.rect=new d.Rect(e.x,e.y,b.width,b.height)};b.prototype.visibleLabels=function(a){a=new d.CGArray;var c=this._visibleRange;c&&(a=1==c.start&&c.stop==this.sequence.length?this._labels:
this._labelsNCList.find(c.start,c.stop));return a};b.prototype.draw=function(a,c){this._labels.length!=this._labelsNCList.length&&this.refresh();this._visibleRange=this.canvas.visibleRangeForRadius(c);this._innerRadius=a;this._outerRadius=c;var g=this.visibleLabels(c);this._calculatePositions(g);this._calculateLabelRects(g);var b=new d.CGArray;this._visibleLabels=new d.CGArray;for(var e=0,h=g.length;e<h;e++)k=g[e],k.rect.overlap(b)||(this._visibleLabels.push(k),b.push(k.rect));var g=this.canvas,b=
g.context("map"),k,l;b.font=this.font.css;b.textAlign="left";b.textBaseline="top";e=0;for(h=this._visibleLabels.length;e<h;e++)k=this._visibleLabels[e],l=k.feature,l=this.color||l.color,g.radiantLine("map",k.bp,c+this._labelLineMargin,this.labelLineLength,this._labelLineWidth,l.rgbaString),b.fillStyle=l.rgbaString,b.fillText(k.name,k.rect.x,k.rect.y);this.viewer.debug&&this.viewer.debug.data.n&&(this.viewer.debug.data.n.labels=this._visibleLabels.length)};Object.defineProperties(b.prototype,{color:{configurable:!0,
enumerable:!0,get:function(){return this._color},set:function(a){this._color=void 0===a||"Color"==a.toString()?a:new d.Color(a)}},labelLineLength:{configurable:!0,enumerable:!0,get:function(){return this._labelLineLength},set:function(a){this._labelLineLength=d.pixel(a)}},font:{configurable:!0,enumerable:!0,get:function(){return this._font},set:function(a){this._font="Font"==a.toString()?a:new d.Font(a);this.refreshLabelWidths()}},length:{configurable:!0,enumerable:!0,get:function(){return this._labels.length}}});
d.Annotation=b})(CGView);
(function(d){var b=function(a,c,g){c=void 0===c?{}:c;g=void 0===g?{}:g;d.CGObject.call(this,a,c,g);a=.4*d3.min([this.viewer.width,this.viewer.height]);this.radius=d.defaultFor(c.radius,a);this.color=d.defaultFor(c.color,"grey");this.font=d.defaultFor(c.font,"sans-serif, plain, 14");this.fontColor=d.defaultFor(c.fontColor,"black");this.thickness=d.defaultFor(c.thickness,5);this._bpThicknessAddition=0;this.bpMargin=4};$jscomp.inherits(b,d.CGObject);b.prototype.toString=function(){return"Backbone"};b.prototype.maxZoomFactor=
function(){return this.sequence.length*this.bpSpacing/(2*Math.PI*this.radius)};b.prototype.pixelsPerBp=function(){return d.pixel(2*this.zoomedRadius*Math.PI/this.sequence.length)};b.prototype._drawSequence=function(){var a=this.canvas.context("map"),c=d.pixel(this.zoomedRadius),g=this.visibleRange,b,e;if(g){this.sequence.seq?(b=this.sequence.forRange(g),e=d.Sequence.complement(b)):(b=this._emptySequence(g.length),e=this._emptySequence(g.length));var h=g.start;a.save();a.fillStyle=this.fontColor.rgbaString;
a.font=this.font.css;a.textAlign="center";a.textBaseline="middle";for(var k=this.bpSpacing/2+this.bpMargin,l=0,g=g.length;l<g;l++){var m=this.canvas.pointFor(h,c+k);a.fillText(b[l],m.x,m.y);m=this.canvas.pointFor(h,c-k);a.fillText(e[l],m.x,m.y);h++}a.restore()}};b.prototype._emptySequence=function(a){return Array(a+1).join("\u2022")};b.prototype.draw=function(){this._visibleRange=this.canvas.visibleRangeForRadius(d.pixel(this.zoomedRadius),100);if(this.visibleRange)if(this.viewer.canvas.drawArc("map",
...
(function(d){var b=function(a,c,g){g=void 0===g?{}:g;this._viewer=a;this.width=d.defaultFor(g.width,600);this.height=d.defaultFor(g.height,600);this.determinePixelRatio(c);this._layerNames=["background","map","captions","ui"];this._layers=this.createLayers(c,this._layerNames,this._width,this._height);this._scale={};this.refreshScales()};b.prototype.determinePixelRatio=function(a){var c=a.append("canvas").style("position","absolute").style("top",0).style("left",0).attr("width",this._width).attr("height",
this._height).node();c.getContext?d.pixelRatio=d.getPixelRatio(c):a.html("<h3>CGView requires Canvas, which is not supported by this browser.</h3>");d3.select(c).remove()};b.prototype.createLayers=function(a,c,g,b){for(var e={},h=0,k=c.length;h<k;h++){var l=c[h],m=10*(h+1),m=a.append("canvas").classed("cgv-layer",!0).classed("cgv-layer-"+l,!0).style("z-index",m).attr("width",g).attr("height",b).node();d.scaleResolution(m,d.pixelRatio);var n=m.getContext("2d");e[l]={ctx:n,node:m}}return e};b.prototype.resize=
function(a,c){this.width=a;this.height=c;for(var g=$jscomp.makeIterator(this.layerNames),b=g.next();!b.done;b=g.next())b=this.layers(b.value).node,b.width=this.width,b.height=this.height,b.style.width=a+"px",b.style.height=c+"px";this.refreshScales()};b.prototype.refreshScales=function(){var a,c,g,b;this.scale.x?(c=this.scale.x.domain(),b=c[1]-c[0],a=c[0]/b,c=c[1]/b):(a=-.5,c=.5);if(this.scale.y){var d=this.scale.y.domain();b=d[0]-d[1];g=d[0]/b;b=d[1]/b}else g=.5,b=-.5;this.scale.x=d3.scaleLinear().domain([this.width*
...
0,d.pixel(this.width),d.pixel(this.height))};b.prototype.drawArc=function(a,c,g,b,e,h,k){e=void 0===e?"#000000":e;h=void 0===h?1:h;k=void 0===k?"arc":k;var l=this.context(a),m=this.viewer.settings;if("arc"==k){if(m.showShading){var n=.1*h,p=h-2*n;l.beginPath();l.strokeStyle=e;l.lineWidth=p;this.arcPath(a,b,c,g);l.stroke();p=p/2+n/2;l.lineWidth=n;l.beginPath();l.strokeStyle=(new d.Color(e)).lighten(.15).rgbaString;this.arcPath(a,b+p,c,g);l.stroke();l.beginPath();l.strokeStyle=(new d.Color(e)).darken(.15).rgbaString;
this.arcPath(a,b-p,c,g)}else l.beginPath(),l.strokeStyle=e,l.lineWidth=h,this.arcPath(a,b,c,g);l.stroke()}if("arc"!=k){p=h*m.arrowHeadLength/this.pixelsPerBp(b);n=this.sequence.lengthOfRange(c,g);n<p&&(n=c+n/2,c=n-p/2,g=n+p/2);n="clockwise-arrow"==k?c:g;g="clockwise-arrow"==k?g:c;k="clockwise-arrow"==k?1:-1;c=h/2;p=g-k*p;g=this.pointFor(g,b);var q=this.pointFor(p,b-c);m.showShading?(h*=.4,m=this.pointFor(p,b-h),l.beginPath(),l.fillStyle=e,this.arcPath(a,b+h,n,p,-1==k),l.lineTo(g.x,g.y),l.lineTo(m.x,
m.y),this.arcPath(a,b-h,p,n,1==k,"noMoveTo"),l.closePath(),l.fill(),q=this.pointFor(p,b+h),l.beginPath(),l.fillStyle=(new d.Color(e)).lighten(.15).rgbaString,this.arcPath(a,b+c,n,p,-1==k),l.lineTo(g.x,g.y),l.lineTo(q.x,q.y),this.arcPath(a,b+h,p,n,1==k,"noMoveTo"),l.closePath(),l.fill(),l.beginPath(),l.fillStyle=(new d.Color(e)).darken(.15).rgbaString,this.arcPath(a,b-c,n,p,-1==k),l.lineTo(g.x,g.y),l.lineTo(m.x,m.y),this.arcPath(a,b-h,p,n,1==k,"noMoveTo")):(l.beginPath(),l.fillStyle=e,this.arcPath(a,
b+c,n,p,-1==k),l.lineTo(g.x,g.y),l.lineTo(q.x,q.y),this.arcPath(a,b-c,p,n,1==k,"noMoveTo"));l.closePath();l.fill()}};b.prototype.arcPath=function(a,c,g,b,d,h){d=void 0===d?!1:d;h=void 0===h?"moveTo":h;a=this.context(a);var k=this.scale;(d?this.sequence.lengthOfRange(b,g):this.sequence.lengthOfRange(g,b))<this.sequence.length/1E3?(b=this.pointFor(b,c),"lineTo"==h?(c=this.pointFor(g,c),a.lineTo(c.x,c.y),a.lineTo(b.x,b.y)):"moveTo"==h?(c=this.pointFor(g,c),a.moveTo(c.x,c.y),a.lineTo(b.x,b.y)):"noMoveTo"==
h&&a.lineTo(b.x,b.y)):a.arc(k.x(0),k.y(0),c,k.bp(g),k.bp(b),d)};b.prototype.radiantLine=function(a,c,g,b,d,h,k){d=void 0===d?1:d;h=void 0===h?"black":h;k=void 0===k?"butt":k;var l=this.pointFor(c,g);c=this.pointFor(c,g+b);a=this.context(a);a.beginPath();a.moveTo(l.x,l.y);a.lineTo(c.x,c.y);a.strokeStyle=h;a.lineCap=k;a.lineWidth=d;a.stroke()};b.prototype.pointFor=function(a,c){var g=this.scale.bp(a),b=this.scale.x(0)+c*Math.cos(g),g=this.scale.y(0)+c*Math.sin(g);return{x:b,y:g}};b.prototype.bpForPoint=
function(a){return Math.round(this.scale.bp.invert(d.angleFromPosition(a.x,a.y)))};b.prototype.visibleRangesForRadius=function(a,c){c=void 0===c?0:c;var g=this;return d.circleAnglesFromIntersectingRect(a,this.scale.x.invert(0-c),this.scale.y.invert(0-c),this.width+2*c,this.height+2*c).map(function(a){return Math.round(g.scale.bp.invert(a))})};b.prototype.visibleRangeForRadius=function(a,c){c=void 0===c?0:c;var g=this.visibleRangesForRadius(a,c);return 2==g.length?new d.CGRange(this.sequence,g[0],
g[1]):2<g.length?new d.CGRange(this.sequence,g[0],g[g.length-1]):a-c>this.maximumVisibleRadius()?void 0:a+c<this.minimumVisibleRadius()?void 0:new d.CGRange(this.sequence,1,this.sequence.length)};b.prototype.centerVisible=function(){var a=this.scale.x(0),c=this.scale.y(0);return 0<=a&&a<=this.width&&0<=c&&c<=this.height};b.prototype.maximumVisibleRadius=function(){var a=Math.max(Math.abs(this.scale.x.invert(0)),Math.abs(this.scale.x.invert(this.width))),c=Math.max(Math.abs(this.scale.y.invert(0)),
...
(function(d){var b=function(a,c,g){c=void 0===c?{}:c;g=void 0===g?{}:g;d.CGObject.call(this,a,c,g);this.viewer=a;this._items=new d.CGArray;this._position=d.defaultFor(c.position,"upper-left");this.name=c.name;this.backgroundColor=c.backgroundColor;this.font=d.defaultFor(c.font,"SansSerif, plain, 8");this.fontColor=d.defaultFor(c.fontColor,"black");this.textAlignment=d.defaultFor(c.textAlignment,"left");if(c.items){var b=this;c.items.forEach(function(a){new (d[b.toString()+"Item"])(b,a)})}this.refresh()};
$jscomp.inherits(b,d.CGObject);b.prototype.toString=function(){return"Caption"};b.prototype.items=function(a){return this._items.get(a)};b.prototype.visibleItems=function(a){var c=this._items.filter(function(a){return a.visible});return(new d.CGArray(c)).get(a)};b.prototype.refresh=function(){this.clear();var a=this.height=0;if(this._items){for(var c=this.visibleItems(),g=0,b=c.length;g<b;g++){var e=c[g].height;this.height+=e;g<b-1&&(this.height+=e/2);e>a&&(a=e)}this.padding=a/2;this.height+=2*this.padding;
this.width=0;g=c.map(function(a){return a.font.css});b=c.map(function(a){return a.text});a=d.Font.calculateWidths(this.ctx,g,b);g=0;for(b=a.length;g<b;g++)e=c[g],e.drawSwatch&&(a[g]+=e.height+this.padding/2),e._width=a[g];this.width=d3.max(a)+2*this.padding;this._updateOrigin();this.draw()}};b.prototype._updateOrigin=function(){var a=d.pixel(0),c=this.canvas.width,b=this.canvas.height,f=this.width,e=this.height,h=this.position;"upper-left"==h?this.originY=this.originX=a:"upper-center"==h?(this.originX=
c/2-f/2,this.originY=a):"upper-right"==h?(this.originX=c-f-a,this.originY=a):"middle-left"==h?(this.originX=a,this.originY=b/2-e/2):"middle-center"==h?(this.originX=c/2-f/2,this.originY=b/2-e/2):"middle-right"==h?(this.originX=c-f-a,this.originY=b/2-e/2):"lower-left"==h?(this.originX=a,this.originY=b-e-a):"lower-center"==h?(this.originX=c/2-f/2,this.originY=b-e-a):"lower-right"==h&&(this.originX=c-f-a,this.originY=b-e-a)};b.prototype.moveItem=function(a,c){this._items.move(a,c);this.refresh()};b.prototype.clear=
...
this.parent;if("left"==this.textAlignment)return a.originX+a.padding;if("center"==this.textAlignment)return a.originX+a.width/2;if("right"==this.textAlignment)return a.originX+a.width-a.padding};b.prototype.textY=function(){var a=this.parent,c=a.originY+a.padding;a._items.indexOf(this);for(var b=0,f=a._items.length;b<f;b++){var d=a._items[b];if(d==this)break;d.visible&&(c+=1.5*d.height)}return c};b.prototype.highlight=function(a){this.visible&&this.parent.visible&&(a=this.canvas.context("ui"),a.lineWidth=
...
new d.CGRange(this.sequence,this.start,a.stop),b=new d.CGRange(this.sequence,a.start,this.stop);a=[this,a,c,b];for(var c=0,f,e=0,h=a.length;e<h;e++)b=a[e].length,b>c&&(c=b,f=a[e]);return f};Object.defineProperties(b.prototype,{sequence:{configurable:!0,enumerable:!0,get:function(){return this._sequence}},sequenceLength:{configurable:!0,enumerable:!0,get:function(){return this.sequence.length}},start:{configurable:!0,enumerable:!0,get:function(){return this._start},set:function(a){this._start=Number(a)}},
...
function(a,c){c=void 0===c?1:c;if(/^#/.test(a))return b.hexString2rgba(a,c);if(/^rgb\(/.test(a))return b.rgbString2rgba(a,c);if(/^rgba\(/.test(a))return b.rgbaString2rgba(a,c);if(/^hsl\(/.test(a))return b.hslStringToRgba(a,c);var g=b.name2HexString(a);return b.hexString2rgba(g,c)};b._validateOpacity=function(a){a=Number(a);isNaN(a)?a=1:1<a?a=1:0>a&&(a=0);return a};b._validateRgba=function(a){return{r:b._validateRgbNumber(a.r),g:b._validateRgbNumber(a.g),b:b._validateRgbNumber(a.b),a:b._validateOpacity(a.a)}};
...
function(a,c,b,g){return c+c+b+b+g+g});var b=0,d=0,e=0,h=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a);h&&(b=parseInt(h[1],16),d=parseInt(h[2],16),e=parseInt(h[3],16));return{r:b,g:d,b:e,a:c}};b.rgb2hsl=function(a){var c=a.r/255,b=a.g/255;a=a.b/255;var d=Math.max(c,b,a),e=Math.min(c,b,a),h,k=(d+e)/2;if(d==e)h=e=0;else{var l=d-e,e=.5<k?l/(2-d-e):l/(d+e);switch(d){case c:h=(b-a)/l+(b<a?6:0);break;case b:h=(a-c)/l+2;break;case a:h=(c-b)/l+4}h/=6}return{h:h,s:e,l:k}};b.hsl2rgb=function(a){var c=
...
(function(d){var b=function(a){a=void 0===a?{}:a;this._data={};this._sections=d.defaultFor(a.sections,[]);a=$jscomp.makeIterator(this.sections);for(var c=a.next();!c.done;c=a.next())this.data[c.value]={}};b.prototype.draw=function(a,c,b){c=void 0===c?10:c;b=void 0===b?20:b;c=d.pixel(c);b=d.pixel(b);var f=this._data,e=this._sections;a.font=d.pixel(10)+"pt Sans-Serif";a.fillStyle="black";var h=d.pixel(18);a.textAlign="left";!0===this.debug&&Object.keys(f);var k=0;e.forEach(function(d){Object.keys(f[d]).forEach(function(e){a.fillText(d+
"|"+e+": "+f[d][e],c,b+h*k);k+=1})})};Object.defineProperties(b.prototype,{sections:{configurable:!0,enumerable:!0,get:function(){return this._sections}},data:{configurable:!0,enumerable:!0,get:function(){return this._data}}});d.Debug=b})(CGView);
(function(d){var b=function(a,c){var b=this;c=c||{};this._wrapper=a._wrapper.node();this.fadeTime=d.defaultFor(c.fadeTime,500);this.header_text=d.defaultFor(c.header_text,"");this.content_text=d.defaultFor(c.content_text,"");this.height=d.defaultFor(c.height,300);this.width=d.defaultFor(c.width,300);this.buttons=c.buttons;this.box=d3.select(this._wrapper).append("div").style("display","none").attr("class","cgv-dialog");this.header=this.box.append("div").attr("class","cgv-dialog-header").html(this.header_text);
this.dismiss=this.box.append("div").attr("class","cgv-dialog-dismiss").html("X").on("click",function(){b.close()});this.contents=this.box.append("div").attr("class","cgv-dialog-contents cgv-scroll");this.buttons&&(this.footer=this.box.append("div").attr("class","cgv-dialog-footer"),this._generate_buttons());this.contents.html(this.content_text);this._adjust_size();return this};b.prototype.open=function(a){a=d.defaultFor(a,this.fadeTime);this._adjust_size();this.box.style("display","block");this.box.transition().duration(a).style("opacity",
1);return this};b.prototype.close=function(a){a=d.defaultFor(a,this.fadeTime);this.box.transition().duration(a).style("opacity",0).on("end",function(){d3.select(this).style("display","none")});return this};b.prototype._generate_buttons=function(){var a=this;Object.keys(this.buttons).forEach(function(c){a.footer.append("button").html(c).attr("class","cgv-button").on("click",function(){a.buttons[c].call(a)})})};b.prototype._adjust_size=function(){var a=this._wrapper.offsetWidth,c=this._wrapper.offsetHeight,
b=this.width,d=this.height;this.height>c-50&&(d=c-50);this.width>a-50&&(b=a-50);a=d-40-(this.buttons?35:0);this.box.style("width",b+"px").style("height",d+"px");this.contents.style("height",a+"px")};Object.defineProperties(b.prototype,{visible:{configurable:!0,enumerable:!0,get:function(){return"none"!=this.box.style("display")}},fadeTime:{configurable:!0,enumerable:!0,get:function(){return this._fadeTime},set:function(a){this._fadeTime=a}}});d.Dialog=b})(CGView);
...
b.prototype._createEvent=function(a){var c=this.canvas.scale,b=d.pixel(a.offsetX);a=d.pixel(a.offsetY);var f=c.x.invert(b),c=c.y.invert(a),e=Math.sqrt(f*f+c*c),h=this.viewer.layout.slotForRadius(e),k=this.canvas.bpForPoint({x:f,y:c}),l=h&&h.findFeaturesForBp(k)[0],m=h&&h._plot,n=m&&m.scoreForPosition(k).toFixed(2);return{bp:k,radius:e,slot:h,feature:l,plot:m,score:n,canvasX:b,canvasY:a,mapX:f,mapY:c,d3:d3.event}};b.prototype._legendSwatchClick=function(){var a=this.viewer;this.events.on("click.swatch",
...
c.plot.scoreForPosition(c.bp);if(b){var f=d.indexOfValue(c.plot.positions,c.bp,!1),e=c.plot.positions[f],f=c.plot.positions[f+1]||a.sequence.length,h=c.slot.radius-c.slot.thickness/2+c.slot.thickness*c.plot.baseline,k=h+(b-c.plot.baseline)*c.slot.thickness,l=Math.abs(h-k),h=Math.min(h,k)+l/2;c=b>=c.plot.baseline?c.plot.colorPositive.copy():c.plot.colorNegative.copy();c.highlight();a.canvas.drawArc("ui",e,f,h,c,l)}}})};Object.defineProperties(b.prototype,{viewer:{configurable:!0,enumerable:!0,get:function(){return this._viewer}},
canvas:{configurable:!0,enumerable:!0,get:function(){return this.viewer.canvas}}});d.EventMonitor=b})(CGView);
(function(d){var b=function(){this._handlers={}};b.prototype.on=function(b,d){var g=this._handlers;a(b);var k=b.replace(/\..*/,"");g[k]||(g[k]=[]);g[k].push(new c(b,d))};b.prototype.off=function(c,b){var d=this._handlers;a(c);var k=c.replace(/\..*/,""),l=g(c);1==arguments.length?l?k?d[k]=d[k].filter(function(a){return a.namespace!=l}):Object.keys(d).forEach(function(a){d[a]=d[a].filter(function(a){return a.namespace!=l})}):d[k]=void 0:d[k]=d[k].filter(function(a){return a.callback!=b})};b.prototype.trigger=
function(c,b){var d=this._handlers;a(c);var k=c.replace(/\..*/,""),l=g(c);Array.isArray(d[k])&&d[k].forEach(function(a){l?a.namespace==l&&a.callback.call(null,b):a.callback.call(null,b)})};var a=function(a){if("string"!=typeof a)throw Error("Type must be a string");},c=function(a,c){this.callback=c;this.event_type=a.replace(/\..*/,"");this.namespace=g(a)},g=function(a){return(result=a.match(/\.(.*)/))?result[1]:void 0};d.Events=b})(CGView);
...
a.plots&&a.plots.forEach(function(a){console.log("PLOT");new d.Plot(c,a)});c.layout=new d.Layout(c,a.layout)};b.prototype.exportImage=function(a,c){var b=this._viewer,f=b.canvas;a=a||b.width;c=c||b.height;var e="CGV-Image-"+a+"x"+c;a/=d.pixelRatio;c/=d.pixelRatio;var h=f._layers,k=b.debug;b.debug=!1;for(var l=f.layerNames.concat(["export"]),m=f.createLayers(d3.select("body"),l,a,c),n=d3.min([a,c])/b.minDimension,p=$jscomp.makeIterator(f.layerNames),q=p.next();!q.done;q=p.next())q=q.value,m[q].ctx.scale(n,
n);f._layers=m;b.drawExport();b.fillBackground();b.legend.draw();q=0;for(n=b._captions.length;q<n;q++)b._captions[q].draw();q=m["export"].ctx;q.drawImage(m.background.node,0,0);q.drawImage(m.map.node,0,0);q.drawImage(m.captions.node,0,0);n=m["export"].node.toDataURL();f._layers=h;b.debug=k;f=$jscomp.makeIterator(l);for(q=f.next();!q.done;q=f.next())q=q.value,d3.select(m[q].node).remove();m=window.open();b=["<html><head><title>",e,'</title></head><body><h2>Your CGView Image is Below</h2><p>To save, right click on either image below and choose "Save Image As...". The two images are the same. The first is scaled down for easier previewing, while the second shows the map at actual size. Saving either image will download the full size map.</p><h3>Preview</h3>',
'<img style="border: 1px solid grey" width="'+b.width+'" height="'+b.height+'" src="'+n+'"/ >',"<h3>Actual Size</h3>",'<img style="border: 1px solid grey" src="'+n+'"/ >',"</body><html>"].join("");m.document.write(b)};d.IO=b})(CGView);
...
(function(d){var b=function(a,c,b,f){c=void 0===c?{}:c;this._viewer=a;this._tracks=new d.CGArray;this._fastMaxFeatures=1E3;if(c.tracks){var e=this;c.tracks.forEach(function(a){new d.Track(e,a)})}this._adjustProportions()};b.prototype._adjustProportions=function(){var a=this.viewer,c=.35*a.minDimension,b=.15*a.minDimension,d=this.visibleSlots().length*(a.slotDivider.thickness+a.slotDivider.spacing),b=c-b-a.backbone.thickness-d,d=this.visibleSlots().filter(function(a){return"plot"==a.type}).length,
...
this.parent.padding,d=this.parent.visibleItems(),e=0,h=d.length;e<h;e++){var k=d[e];if(k==this)break;b+=1.5*k.height}if(a.x>=c&&a.x<=c+this.height&&a.y>=b&&a.y<=b+this.height)return!0};b.prototype.features=function(a){var b=this;return(new d.CGArray(this.viewer._features.filter(function(a){return a.legendItem==b}))).get(a)};b.prototype.plots=function(a){var b=this;return(new d.CGArray(this.viewer._plots.filter(function(a){return a.legendItem==b||a.legendItemPositive==b||a.legendNegative==b}))).get(a)};
...
k(this.nav_group,0,0,15,30,p);this.scroll_right_button=k(this.nav_group,17,0,15,30,q);this.nav_group.attr("transform","translate(7,4)");$(document).mouseup(function(){});this.zoom_group=this._menu_svg.append("g");this.zoom_y_minus_button=k(this.zoom_group,6,18,16,16,g(this._menu_svg));this.zoom_y_plus_button=k(this.zoom_group,6,0,16,16,c(this._menu_svg));this.zoom_x_minus_button=k(this.zoom_group,25,9,16,16,g(this._menu_svg));this.zoom_x_plus_button=k(this.zoom_group,43,9,16,16,c(this._menu_svg));
...
"cgv-button-text").style("text-anchor","middle").text("?");this.help_button=k(this._menu_svg,260,4,30,30,p);this.help_button.on("click",function(){b.help.dialog.open()});p=h(this._menu_svg).attr("transform","translate(5,7)");this.download_button=k(this._menu_svg,220,4,30,30,p);this.download_dialog=new d.Dialog(b,{header_text:"Save Image",content_text:'<div class="cgv-alert">Display the viewer image in a new window to download or print. Note that you must allow pop-ups!</div><div><label class="cgv-label">Size</label><div class="cgv-input-group"><input class="cgv-input" id="cgv-save-width" type="text" value="'+
b.width+'" /><div class="cgv-input-addon">px</div></div></div>',buttons:{Cancel:function(){this.close()},Generate:function(){var a=b._wrapper.select("#cgv-save-width").property("value"),c=b._wrapper.select("#cgv-save-width").property("value");b.io.exportImage(c,a);this.close()}},width:400,height:200});this.download_button.on("click",function(){n.download_dialog.open()});p=e(this._menu_svg).attr("transform","translate(5,5)");this.settings_button=k(this._menu_svg,180,4,30,30,p);this.settings_button.on("click",
...
l(b)).attr("stroke","black").attr("stroke-width",3).attr("fill","none")},c=function(a){a=a.append("g");a.append("line").attr("x1",3).attr("y1",8).attr("x2",13).attr("y2",8).attr("stroke-width",3).attr("stroke","black");a.append("line").attr("x1",8).attr("y1",3).attr("x2",8).attr("y2",13).attr("stroke-width",3).attr("stroke","black");return a},g=function(a){return a.append("line").attr("x1",3).attr("y1",8).attr("x2",13).attr("y2",8).attr("stroke-width",3).attr("stroke","black")},f=function(a,b,c,d,
g,e){a=a.append("g");var f=c+2,h=c+g-2,k=b+d/2;a.append("line").attrs({x1:b,y1:c,x2:b+d,y2:c,"stroke-width":1});a.append("line").attrs({x1:b,y1:c+g,x2:b+d,y2:c+g,"stroke-width":1});a.append("line").attrs({x1:k,y1:f,x2:k,y2:h,"stroke-width":1});a.append("line").attrs({x1:k,y1:f,x2:k-2,y2:f+2,"stroke-width":1});a.append("line").attrs({x1:k,y1:f,x2:k+2,y2:f+2,"stroke-width":1});a.append("line").attrs({x1:k,y1:h,x2:k-2,y2:h-2,"stroke-width":1});a.append("line").attrs({x1:k,y1:h,x2:k+2,y2:h-2,"stroke-width":1});
a.attr("stroke","rgb(150, 150, 150)").attr("transform","rotate("+e+","+b+","+c+")");return a},e=function(a){a=a.append("g");a.append("circle").attrs({cx:10,cy:10,r:7}).style("fill","rgb(75, 75, 75");a.append("line").attrs({x1:10,y1:1,x2:10,y2:19,"stroke-width":4});a.append("line").attrs({x1:1,y1:10,x2:19,y2:10,"stroke-width":4});a.append("line").attrs({x1:3.5,y1:3.5,x2:16.5,y2:16.5,"stroke-width":4});a.append("line").attrs({x1:16.5,y1:3.5,x2:3.5,y2:16.5,"stroke-width":4});a.append("circle").attrs({cx:10,
cy:10,r:3}).style("fill","white");return a},h=function(a){a=a.append("g");a.append("line").attrs({x1:10,y1:0,x2:10,y2:12,"stroke-linecap":"round","stroke-width":3});a.append("line").attrs({x1:6,y1:7,x2:10,y2:12,"stroke-linecap":"round","stroke-width":3});a.append("line").attrs({x1:14,y1:7,x2:10,y2:12,"stroke-linecap":"round","stroke-width":3});a.append("line").attrs({x1:2,y1:16,x2:18,y2:16,"stroke-linecap":"round","stroke-width":3});return a},k=function(a,b,c,d,g,e){a=a.append("g").attr("class","cgv-menu-button");
a.append("rect").attr("x",0).attr("y",0).attr("width",d).attr("height",g).attr("rx",2).attr("ry",2).style({"stroke-width":1});var f=e.remove();a.append("g").attr("class","cgv-button-image").append(function(){return f.node()});a.attr("transform","translate("+b+".5,"+c+".5)");return a},l=d3.line().x(function(a){return a.x}).y(function(a){return a.y});d.Menu=b})(CGView);
(function(d){var b=function(a,b){b=void 0===b?{}:b;this._viewer=a;this._wrapper=a._wrapper.node();this.fadeTime=d.defaultFor(b.fadeTime,100);this.height=d.defaultFor(b.height,40);this.width=d.defaultFor(b.width,200);this.box=d3.select(this._wrapper).append("div").style("display","none").attr("class","cgv-messenger").style("width",this.height).style("height",this.width);this.contents=this.box.append("div").attr("class","cgv-messenger-contents");this._adjust_size();return this};b.prototype.toString=
function(){return"Messenger"};b.prototype.open=function(a){d.defaultFor(a,this.fadeTime);this._adjust_size();this.box.style("display","block");this.box.style("opacity",1);return this};b.prototype.close=function(a){a=d.defaultFor(a,this.fadeTime);this.box.transition().duration(a).style("opacity",0).on("end",function(){d3.select(this).style("display","none")});return this};b.prototype._adjust_size=function(){var a=this._wrapper.offsetWidth,b=this._wrapper.offsetHeight,d=this.width,f=this.height;this.height>
b-50&&(f=b-50);this.width>a-50&&(d=a-50);this.box.style("width",d+"px").style("height",f+"px")};b.prototype.flash=function(a){this.contents.html(a);this.open()};Object.defineProperties(b.prototype,{viewer:{configurable:!0,enumerable:!0,get:function(){return this._viewer}},visible:{configurable:!0,enumerable:!0,get:function(){return"none"!=this.box.style("display")}},fadeTime:{configurable:!0,enumerable:!0,get:function(){return this._fadeTime},set:function(a){this._fadeTime=a}}});d.Messenger=b})(CGView);
(function(d){var b=function(a,b){a=void 0===a?[]:a;b=void 0===b?{}:b;this.intervals=[];this.circularLength=b.circularLength;this.fill(a)};b.prototype._normalize=function(a){for(var b,d=[],f=0,e=a.length;f<e;f++)b=a[f],b.start<=b.stop?d.push({interval:b,index:f}):(d.push({interval:b,index:f,start:b.start,stop:this.circularLength,crossesOrigin:!0}),d.push({interval:b,index:f,start:1,stop:b.stop,crossesOrigin:!0}));return d};b.prototype.fill=function(a){this._length=a.length;if(0==a.length)this.topList=
[];else{var b=this.start,d=this.end,f=this.sublist;this.intervals=a=this._normalize(a);a.sort(function(a,e){return b(a)!=b(e)?b(a)-b(e):d(e)-d(a)});var e=[],h=[];this.topList=h;h.push(a[0]);if(1!=a.length)for(var k,l,m=1,n=a.length;m<n;m++)if(k=a[m],d(k)<d(a[m-1]))e.push(h),h=Array(k),f(a[m-1],h);else for(;;)if(0==e.length){h.push(k);break}else if(l=e[e.length-1],d(l[l.length-1])>d(k)){h.push(k);break}else h=e.pop()}};b.prototype.end=function(a){return a.stop||a.interval.stop};b.prototype.start=function(a){return a.start||
a.interval.start};b.prototype.sublist=function(a,b){a.sublist=b};b.prototype._run=function(a,b,d,f,e){b=void 0===b?a:b;d=void 0===d?1:d;f=void 0===f?function(){}:f;e=void 0===e?this.topList:e;var h,k=e.length,l,m;0<d?(m=1,l=this._binarySearch(e,a,!0,"end")):0>d&&(m=-1,l=this._binarySearch(e,b,!1,"start"));for(;0<=l&&l<k&&(1==m?this.start(e[l])<=b:this.end(e[l])>=a);)h=!1,e[l].crossesOrigin&&(-1!=this._runIntervalsCrossingOrigin.indexOf(e[l].interval)?h=!0:this._runIntervalsCrossingOrigin.push(e[l].interval)),
h||0!=e[l].index%d||f.call(e[l].interval,e[l].interval),e[l].sublist&&this._run(a,b,d,f,e[l].sublist),l+=m};b.prototype.run=function(a,b,d,f){b=void 0===b?a:b;d=void 0===d?1:d;f=void 0===f?function(){}:f;this._runIntervalsCrossingOrigin=[];this.circularLength&&b<a?(this._run(a,this.circularLength,d,f),this._run(1,b,d,f)):this._run(a,b,d,f)};b.prototype.count=function(a,b,d){var f=0;this.run(a,b,d,function(a){f++});return f};b.prototype.find=function(a,b,d){var f=[];this.run(a,b,d,function(a){f.push(a)});
return f};b.prototype._binarySearch=function(a,b,d,f){for(var e=-1,h=a.length,k,l;1<h-e;)if(k=(e+h)/2|0,l=this[f](a[k]),l<b)e=k;else if(l>b)h=k;else return k;return d?h:e};b.test=function(){function a(a,b,c,d){a=a.find(b,c).map(function(a){return a.name}).sort().join(", ");d=d.sort().join(", ");b=""+b+".."+c+": "+d+" - "+(a==d?"Pass":"FAIL - "+a);console.log(b)}var b=new d.NCList([{name:"A",start:1,stop:20},{name:"B",start:10,stop:15},{name:"C",start:10,stop:20},{name:"D",start:15,stop:30},{name:"E",
...
(function(d){var b=function(a,b,g,f){b=void 0===b?{}:b;this.viewer=a;this.positions=b.positions;this.scores=b.scores;this.source=d.defaultFor(b.source,"");this._baseline=d.defaultFor(b.baseline,.5);b.legend&&(this.legendItem=b.legend);b.legendPositive&&(this.legendItemPositive=b.legendPositive);b.legendNegative&&(this.legendItemNegative=b.legendNegative);a=a.plots().indexOf(this)+1;this.legendItemPositive||this.legendItemNegative?this.legendItemPositive?this.legendItemNegative||(this.legendItemNegative=
this.legendItemPositive):this.legendItemPositive=this.legendItemNegative:this.legendItem="Plot-"+a};b.prototype.scoreForPosition=function(a){var b=d.indexOfValue(this.positions,a);return 0==b&&a<this.positions[b]?void 0:this.scores[b]};b.prototype.draw=function(a,b,d,f,e){this.colorNegative.rgbaString==this.colorPositive.rgbaString?this._drawPath(a,b,d,f,e,this.colorPositive):(this._drawPath(a,b,d,f,e,this.colorPositive,"positive"),this._drawPath(a,b,d,f,e,this.colorNegative,"negative"))};b.prototype._drawPath=
function(a,b,g,f,e,h,k){var l=this,m=a.context("map"),n=this.positions,p=this.scores,q=this.viewer.sequence.length,r=d.indexOfValue(n,e.start,!1),t=d.indexOfValue(n,e.stop,!1);0==t&&e.stop<n[t]&&(t=n.length-1);var x=0==r?n[r]:e.start;e=e.stop;var z=p[r],z=this._keepPoint(z,k)?z:this.baseline;m.beginPath();var u=b-g/2+g*this.baseline;b=a.pointFor(x,u);m.moveTo(b.x,b.y);var v=u+(z-this.baseline)*g,y=x,w,A;b=1;f&&(f=n.countFromRange(x,e)/4E3,1<f&&(b=d.base2(f)));n.eachFromRange(x,e,b,function(b){0==
b&&0!=r&&(a.arcPath("map",v,y,q,!1,"lineTo"),y=1,v=u);w=p[b];A=n[b];a.arcPath("map",v,y,A,!1,"lineTo");v=l._keepPoint(w,k)?u+(w-l.baseline)*g:u;y=A});t==n.length-1&&e<n[0]&&(e=q);a.arcPath("map",v,y,e,!1,"lineTo");t=a.pointFor(e,u);m.lineTo(t.x,t.y);a.arcPath("map",u,e,x,!0,"noMoveTo");m.fillStyle=h.rgbaString;m.fill()};b.prototype._keepPoint=function(a,b){return void 0==b||"positive"==b&&a>this.baseline||"negative"==b&&a<this.baseline?!0:!1};Object.defineProperties(b.prototype,{viewer:{configurable:!0,
...
(function(d){var b=function(a,b,d,f){this.x=a;this.y=b;this.width=d;this.height=f};b.prototype.overlap=function(a){for(var b=d.pixel(4),g=!1,f=0,e=a.length;f<e;f++)if(g=a[f],this.x<=g.right&&g.x<=this.right+b&&this.y<=g.bottom&&g.y<=this.bottom){g=!0;break}else g=!1;return g};b.prototype.containsPt=function(a,b){return a>=this.x&&a<=this.x+this.width&&b>=this.y&&b<=this.y+this.height};Object.defineProperties(b.prototype,{width:{configurable:!0,enumerable:!0,get:function(){return this._width},set:function(a){this._width=
...
(function(d){var b=function(a,b,g){b=void 0===b?{}:b;g=void 0===g?{}:g;d.CGObject.call(this,a,b,g);this.tickCount=d.defaultFor(b.tickCount,10);this.tickWidth=d.defaultFor(b.tickWidth,1);this.tickLength=d.defaultFor(b.tickLength,4);this.rulerPadding=d.defaultFor(b.rulerPadding,10);this.font=d.defaultFor(b.font,"sans-serif, plain, 10");this.color=new d.Color(d.defaultFor(b.color,"black"));this.lineCap="round"};$jscomp.inherits(b,d.CGObject);b.prototype._createTickFormatter=function(a){var b;50>=a?b=
d3.formatPrefix(",.0",1):5E4>=a?(a=d3.precisionPrefix(a,1E3),b=d3.formatPrefix("."+a,1E3)):5E7>=a&&(a=d3.precisionPrefix(a,1E6),b=d3.formatPrefix("."+a,1E6));return b};b.prototype._updateTicks=function(a,b){var g=this.sequence.length,f=0,e=0,h=new d.CGArray,k=0,l=new d.CGArray,m=0,l=this.tickCount;if(5>this.viewer.zoomFactor)f=1,e=g;else{var l=Math.ceil(l/2),m=this.canvas.visibleRangeForRadius(a),n=this.canvas.visibleRangeForRadius(b);m&&n?(e=m.mergeWithRange(n),f=e.start,e=e.stop):m?(f=m.start,e=
m.stop):n&&(f=n.start,e=n.stop)}if(e>f)h.merge(d3.ticks(f,e,l)),k=d3.tickStep(f,e,l);else if(e<f)if(m=(g-f)/this.sequence.lengthOfRange(f,e),k=Math.round(l*m),m=2*Math.round(l*(1-m)),0<k)for(h.merge(d3.ticks(f,g,k)),k=Math.round(d3.tickStep(f,g,k)),e=1;e<=m;e++)k*e<f&&h.push(k*e);else h.merge(d3.ticks(1,e,l)),k=Math.round(d3.tickStep(1,e,l));l=new d.CGArray;if(m=k%5?k%2?0:k/2:k/5){this.sequence.lengthOfRange(h[h.length-1],h[0])<=3*k?(f=0,e=g):(f=h[0]-k,e=h[h.length-1]+k);if(!(f<e)){for(;f<=g;f+=m)f%
k&&l.push(f);f=0}for(;f<=e;f+=m)f%k&&l.push(f)}this._majorTicks=h;this._majorTickStep=k;this._minorTicks=l;this._minorTickStep=m;this._tickFormater=this._createTickFormatter(k)};b.prototype.draw=function(a,b){this.visible&&(this._updateTicks(a,b),this.drawForRadius(a,"inner"),this.drawForRadius(b,"outer",!1))};b.prototype.drawForRadius=function(a,b,d){b=void 0===b?"inner":b;d=void 0===d?!0:d;var f=this,e=this.canvas.context("map"),h="inner"==b?-this.tickLength:this.tickLength;e.fillStyle=this.color.rgbaString;
e.font=this.font.css;e.textAlign="left";e.textBaseline="top";this.canvas.radiantLine("map",1,a,h,2*this.tickWidth,this.color.rgbaString,this.linecap);this.majorTicks.each(function(e,l){f.canvas.radiantLine("map",l,a,h,f.tickWidth,f.color.rgbaString,f.linecap);if(d){var m=f.tickFormater(l);f.drawLabel(l,m,a,b)}});this.minorTicks.each(function(b,c){f.canvas.radiantLine("map",c,a,h/2,f.tickWidth,f.color.rgbaString,f.linecap)})};b.prototype.drawLabel=function(a,b,g,f){var e=this.canvas.scale;f=this.canvas.context("map");
b=b.replace(/([kM])?$/," $1bp");g=this.canvas.pointFor(a,g-this.rulerPadding);a=e.bp(a);a=d.clockPositionForAngle(a);e=this.font.width(f,b);g=d.rectOriginForAttachementPoint(g,a,e,this.font.height);f.fillText(b,g.x,g.y)};Object.defineProperties(b.prototype,{font:{configurable:!0,enumerable:!0,get:function(){return this._font},set:function(a){this._font="Font"==a.toString()?a:new d.Font(a)}},color:{configurable:!0,enumerable:!0,get:function(){return this._color},set:function(a){"Color"==a.toString()?
this._color=a:this._color.setColor(a)}},tickCount:{configurable:!0,enumerable:!0,get:function(){return this._tickCount},set:function(a){this._tickCount=a}},tickWidth:{configurable:!0,enumerable:!0,get:function(){return this._tickWidth},set:function(a){this._tickWidth=d.pixel(a)}},tickLength:{configurable:!0,enumerable:!0,get:function(){return this._tickLength},set:function(a){this._tickLength=d.pixel(a)}},rulerPadding:{configurable:!0,enumerable:!0,get:function(){return this._rulerPadding},set:function(a){this._rulerPadding=
d.pixel(a)}},majorTicks:{configurable:!0,enumerable:!0,get:function(){return this._majorTicks}},majorTickStep:{configurable:!0,enumerable:!0,get:function(){return this._majorTickStep}},minorTicks:{configurable:!0,enumerable:!0,get:function(){return this._minorTicks}},minorTickStep:{configurable:!0,enumerable:!0,get:function(){return this._minorTickStep}},tickFormater:{configurable:!0,enumerable:!0,get:function(){return this._tickFormater}}});d.Ruler=b})(CGView);
(function(d){var b=function(a,b){b=void 0===b?{}:b;this._viewer=a;this.color=d.defaultFor(b.color,"black");this.font=d.defaultFor(b.font,"sans-serif, plain, 14");this.seq=b.seq;this.seq||(this.length=b.length);this.length||(this.length=1E3)};b.complement=function(a){for(var b="",d,f,e=0,h=a.length;e<h;e++){d=a.charAt(e);switch(d){case "A":f="T";break;case "T":f="A";break;case "G":f="C";break;case "C":f="G"}b+=f}return b};b.baseCalculation=function(a,c){if("gc_content"==a)return b.calcGCContent(c);
if("gc_skew"==a)return b.calcGCSkew(c)};b.calcGCContent=function(a){if(0==a.length)return.5;var b=d.Sequence.count(a,"g"),g=d.Sequence.count(a,"c");return(b+g)/a.length};b.calcGCSkew=function(a){var b=d.Sequence.count(a,"g");a=d.Sequence.count(a,"c");return 0==b+a?.5:.5+(b-a)/(b+a)/2};b.reverseComplement=function(a){return b.complement(a.split("").reverse().join(""))};b.count=function(a,b){return(a.match(new RegExp(b,"gi"))||[]).length};b.random=function(a){for(var b="",d,f=0;f<a;f++)switch(d=Math.floor(4*
...
b){return b<a?a-b:this.length+a-b};b.prototype.addBp=function(a,b){return this.length>=b+a?b+a:a-this.length+b};b.prototype.forRange=function(a){return this.seq?a.spansOrigin()?this.seq.substr(a.start-1)+this.seq.substr(0,a.stop):this.seq.substr(a.start-1,a.length):this._fakeSequenceForRange(a)};b.prototype._fakeSequenceForRange=function(a){var b="",d=a.start,f=0;for(a=a.length;f<a;f++){switch(d%4){case 0:b+="A";break;case 1:b+="T";break;case 2:b+="G";break;case 3:b+="C"}d++}return b};b.prototype._drawSequence=
function(){var a=this.canvas.context("map"),b=d.pixel(this.zoomedRadius),g=this.visibleRange;if(g){var f=this._sequenceForRange(g),e=g.start;a.save();a.fillStyle=this.fontColor.rgbaString;a.font=this.font.css;a.textAlign="center";a.textBaseline="middle";for(var h=this.bpSpacing/2+this.bpMargin,k=0,g=g.length;k<g;k++){var l=this.canvas.pointFor(e,b+h);a.fillText(f[k],l.x,l.y);l=this.canvas.pointFor(e,b-h);a.fillText(f[k],l.x,l.y);e++}a.restore()}};b.prototype.findPattern=function(a,b){b=void 0===b?
1:b;for(var g=new RegExp(a,"g"),f=[],e,h,k=1==b?this.seq:this.reverseComplement();null!=(e=g.exec(k));)h=1==b?e.index+1:this.length-e.index-e[0].length+1,f.push(new d.CGRange(this,h,h+e[0].length-1)),g.lastIndex=e.index+1;return f};b.prototype.featuresByReadingFrame=function(a){var b=this,g={rf_plus_1:new d.CGArray,rf_plus_2:new d.CGArray,rf_plus_3:new d.CGArray,rf_minus_1:new d.CGArray,rf_minus_2:new d.CGArray,rf_minus_3:new d.CGArray},f;a.each(function(a,d){-1==d.strand?(f=(b.length-d.stop+1)%3,
0==f&&(f=3),g["rf_minus_"+f].push(d)):(f=d.start%3,0==f&&(f=3),g["rf_plus_"+f].push(d))});return g};Object.defineProperties(b.prototype,{viewer:{configurable:!0,enumerable:!0,get:function(){return this._viewer}},canvas:{configurable:!0,enumerable:!0,get:function(){return this.viewer.canvas}},seq:{configurable:!0,enumerable:!0,get:function(){return this._seq},set:function(a){(this._seq=a)?(this._seq=this._seq.toUpperCase(),this._length=a.length,this._updateScale(),this._sequenceExtractor=new d.SequenceExtractor(this)):
...
(function(d){var b=function(a,b){this.sequence=a;if(!a.seq)throw"Sequence invalid. The sequence must be provided.";};b.prototype.fn2workerURL=function(a){a=new Blob(["("+a.toString()+")()"],{type:"application/javascript"});return URL.createObjectURL(a)};b.prototype.extractTrackData=function(a,b,g){g=void 0===g?{}:g;if(d.validate(b,["start_stop_codons","orfs","gc_skew","gc_content"]))switch(b){case "start_stop_codons":case "orfs":a.contents.type="feature";this.generateFeatures(a,b,g);break;case "gc_skew":case "gc_content":a.contents.type=
"plot",this.generatePlot(a,b,g)}};b.prototype.generateFeatures=function(a,b,g){g=void 0===g?{}:g;var f=this;if(d.validate(b,["start_stop_codons","orfs"])){var e=(new Date).getTime(),h=this.viewer,k=this.fn2workerURL(d.WorkerFeatureExtraction),k=new Worker(k);g={type:b,startPattern:d.defaultFor(g.start,"ATG"),stopPattern:d.defaultFor(g.stop,"TAA,TAG,TGA"),seqString:this.seqString,minORFLength:d.defaultFor(g.minORFLength,100)};k.postMessage(g);k.onmessage=function(g){var k=g.data.messageType;"progress"==
k&&(a.loadProgress=g.data.progress,h.layout.drawProgress());if("complete"==k){a.loadProgress=100;g=g.data.featureDataArray;console.log("Features '"+b+"' Worker Time: "+d.elapsed_time(e));k=new d.CGArray;e=(new Date).getTime();var n,p=f.createLegendItems(b);f.getFeatureType(b);console.log(b);for(var q=0,r=g.length;q<r;q++)n=g[q],n.legend=p[n.type],k.push(new d.Feature(h,n));console.log("Features '"+b+"' Creation Time: "+d.elapsed_time(e));e=(new Date).getTime();a._features=k;a.updateSlots();console.log("Features '"+
b+"' Update Time: "+d.elapsed_time(e));h.drawFull()}};k.onerror=function(a){}}};b.prototype.generatePlot=function(a,b,g){g=void 0===g?{}:g;var f=this;if(d.validate(b,["gc_content","gc_skew"])){var e=(new Date).getTime(),h=this.viewer,k=this.fn2workerURL(d.WorkerBaseContent),k=new Worker(k);g={type:b,window:d.defaultFor(g.window,this.getWindowStep().window),step:d.defaultFor(g.step,this.getWindowStep().step),deviation:d.defaultFor(g.deviation,"scale"),seqString:this.seqString};k.postMessage(g);k.onmessage=
function(g){var k=g.data.messageType;"progress"==k&&(a.loadProgress=g.data.progress,h.layout.drawProgress());"complete"==k&&(g=g.data.baseContent,g={positions:g.positions,scores:g.scores,baseline:g.average},g.legendPositive=f.getLegendItem(b,"+").text,g.legendNegative=f.getLegendItem(b,"-").text,g=new d.Plot(h,g),a._plot=g,a.updateSlots(),console.log("Plot '"+b+"' Worker Time: "+d.elapsed_time(e)),h.drawFull())};k.onerror=function(a){}}};b.prototype.getFeatureType=function(a){var b=this.viewer;switch(a){case "start_stop_codons":a=
...
b.prototype.findLargestFeatureLength=function(){for(var a=0,b,d=0,f=this._features.length;d<f;d++)b=this._features[d].length,b>a&&(a=b);return a};b.prototype.clear=function(){var a=this._visibleRange;if(a){var b=this.radius,d=this.thickness,f=this.canvas.context("map");f.globalCompositeOperation="destination-out";this.canvas.drawArc("map",a.start,a.stop,b,"white",d);f.globalCompositeOperation="source-over"}};b.prototype.highlight=function(a){var b=this._visibleRange;b&&this.visible&&this.canvas.drawArc("background",
...
m,function(a){a.draw("map",g,f,e)});this.viewer.debug&&this.viewer.debug.data.n&&(h=this.viewer._slots.indexOf(this),this.viewer.debug.data.n["slot_"+h]=l)}else this.hasPlot&&this._plot.draw(a,g,f,b,e)}};b.prototype.drawProgress=function(a){var b=this.canvas,d=this.radius,f=this.thickness,e=this._visibleRange;0<a&&100>a&&e&&b.drawArc("background",e.start,e.stop,d,"#EAEAEE",f*a/100)};b.prototype.removeFeature=function(a){this._features=this._features.remove(a);this.refresh()};Object.defineProperties(b.prototype,
...
this.updateSlots()};b.prototype.extractFromSequence=function(){var a=this.viewer.sequence.sequenceExtractor;a?a.extractTrackData(this,this.contents.extract,this.contents.options):console.error("No sequence is available to extract features/plots from")};b.prototype.updateFeatures=function(){if("source"==this.contents.from){var a=this;this.viewer.features().each(function(b,c){c.source==a.contents.extract&&a._features.push(c)})}else if(this.contents.types){var b=this,g=new d.CGArray(this.contents.featureType);
this.viewer.features().each(function(a,d){g.contains(d.type)&&b._features.push(d)})}};b.prototype.updatePlot=function(){if("source"==this.contents.from){var a=this;this.viewer.plots().find(function(b){b.source==a.contents.extract&&(a._plot=b)})}};b.prototype.updateSlots=function(){"feature"==this.type?this.updateFeatureSlots():"plot"==this.type&&this.updatePlotSlot();this.layout._adjustProportions();this.viewer.trigger("track-update",this)};b.prototype.updateFeatureSlots=function(){this._slots=new d.CGArray;
if("separated"==this.readingFrame){for(var a=this.sequence.featuresByReadingFrame(this.features()),b=$jscomp.makeIterator([1,2,3]),g=b.next();!g.done;g=b.next()){var g=g.value,f=new d.Slot(this,{strand:"direct"});f.replaceFeatures(a["rf_plus_"+g])}b=$jscomp.makeIterator([1,2,3]);for(g=b.next();!g.done;g=b.next())g=g.value,f=new d.Slot(this,{strand:"reverse"}),f.replaceFeatures(a["rf_minus_"+g])}else"separated"==this.strand?(a=this.featuresByStrand(),f=new d.Slot(this,{strand:"direct"}),f.replaceFeatures(a.direct),
f=new d.Slot(this,{strand:"reverse"}),f.replaceFeatures(a.reverse)):"combined"==this.strand&&(f=new d.Slot(this,{strand:"direct"}),f.replaceFeatures(this.features()))};b.prototype.featuresByStrand=function(){var a={};a.direct=new d.CGArray;a.reverse=new d.CGArray;this.features().each(function(b,d){-1==d.strand?a.reverse.push(d):a.direct.push(d)});return a};b.prototype.updatePlotSlot=function(){this._slots=new d.CGArray;(new d.Slot(this,{type:"plot"}))._plot=this._plot};b.prototype.highlight=function(a){a=
...
(function(d){d.testSearch=function(b){var a=/ATG/igm,c=[],g="";console.log("Making Sequence...");for(var f=0;f<b;f++)g+="ATCG".charAt(Math.floor(4*Math.random()));window.seq=g;console.log("Finding Pattern...");for(b=(new Date).getTime();match=a.exec(g);)c.push(match.index);console.log("ATGs found: "+c.length);console.log("Time: "+d.elapsed_time(b))};d.defaultFor=function(b,a){return void 0===b?a:b};d.validate=function(b,a){if(-1!=a.indexOf(b))return!0;console.error("The value '"+b+"' is not one of the following: "+
...
b.style.height=d+"px"}};d.elapsed_time=function(b){return(new Date).getTime()-b+" ms"};d.angleFromPosition=function(b,a){var c=.5*Math.PI;0!=b&&(c=Math.atan(Math.abs(a/b)));0<=a&&0<=b?c=0-c:0>a&&0<=b||(0>a&&0>b?c=Math.PI-c:0<=a&&0>b&&(c=Math.PI+c));return c};d.clockPositionForAngle=function(b){b=Math.round(6/Math.PI*(b+Math.PI/2));12<b?b-=12:1>b&&(b+=12);return b};d.rectOriginForAttachementPoint=function(b,a,c,d){var f,e;switch(a){case 1:f=b.x-3*c/4;e=b.y;break;case 2:f=b.x-c;e=b.y;break;case 3:f=
b.x-c;e=b.y-d/2;break;case 4:f=b.x-c;e=b.y-d;break;case 5:f=b.x-3*c/4;e=b.y-d;break;case 6:f=b.x-c/2;e=b.y-d;break;case 7:f=b.x-c/4;e=b.y-d;break;case 8:f=b.x;e=b.y-d;break;case 9:f=b.x;e=b.y-d/2;break;case 10:f=b.x;e=b.y;break;case 11:f=b.x-c/4;e=b.y;break;case 12:f=b.x-c/2,e=b.y}return{x:f,y:e}};d.round=function(b,a){return Number(b.toFixed(a||2))};d.dotProduct=function(b,a){for(var c=0,d=0,f=b.length;d<f;d++)c+=b[d]*a[d];return c};d.pointsAdd=function(b,a){var c=[0,0];c[0]=b[0]+a[0];c[1]=b[1]+
a[1];return c};d.pointsSubtract=function(b,a){var c=[0,0];c[0]=b[0]-a[0];c[1]=b[1]-a[1];return c};d.circleAnglesFromIntersectingLine=function(b,a,c,g,f){var e=d.pointsSubtract([g,f],[a,c]),h=[a,c],k=d.dotProduct(e,e),e=2*d.dotProduct(h,e);b=d.dotProduct(h,h)-b*b;var l=e*e-4*k*b;b={};0<=l&&(l=Math.sqrt(l),h=(-e-l)/(2*k),k=(-e+l)/(2*k),0<=h&&1>=h&&(b.t1=d.angleFromPosition(a+h*(g-a),c+h*(f-c))),0<=k&&1>=k&&(b.t2=d.angleFromPosition(a+k*(g-a),c+k*(f-c))));return b};d.circleAnglesFromIntersectingRect=
function(b,a,c,g,f){var e=[];e.push(d.circleAnglesFromIntersectingLine(b,a,c,a+g,c));e.push(d.circleAnglesFromIntersectingLine(b,a+g,c,a+g,c-f));e.push(d.circleAnglesFromIntersectingLine(b,a+g,c-f,a,c-f));e.push(d.circleAnglesFromIntersectingLine(b,a,c-f,a,c));e=e.filter(function(a){return 0<Object.keys(a).length});0<e.length&&(b=Object.keys(e[0]),1==b.length&&"t1"==b[0]&&e.push(e.shift()),2==b.length&&(e.push({t1:e[0].t1}),e[0].t1=void 0),e=e.map(function(a){var b=[];void 0!=a.t1&&b.push(a.t1);void 0!=
a.t2&&b.push(a.t2);return b}),e=[].concat.apply([],e));return e};d.indexOfValue=function(b,a,c){var d=0,f=b.length-1,e,h;if(b[d]>=a)return d;if(b[f]<=a)return f;for(;1<f-d;)if(e=(d+f)/2|0,h=b[e],h<a)d=e;else if(h>a)f=e;else return e;return c?f:d};d.oppositeSigns=function(b,a){return 0>b*a};d.base2=function(b){return Math.pow(2,Math.ceil(Math.log(b)/Math.log(2)))};d.constrain=function(b,a,c){return Math.max(Math.min(c,b),a)};d.merge=function(){for(var b={},a,c,d,f=0,e=arguments.length;f<e;f++)if(a=
arguments[f],"object"===typeof a){c=Object.keys(a);for(var h=0,k=c.length;h<k;h++)d=c[h],b[d]=a[d]}return b};d.scaleValue=function(b,a,c){a=void 0===a?{min:0,max:1}:a;c=void 0===c?{min:0,max:1}:c;return(c.max-c.min)*(b-a.min)/(a.max-a.min)+c.min}})(CGView);
(function(d){d.Viewer.prototype.initializeDragging=function(){var b=this;b._drag=d3.drag().on("start",function(){d3.select(b.canvas.node("ui")).style("cursor","all-scroll")}).on("drag",function(){var a=(new Date).getTime();domain_x=b.scale.x.domain();domain_y=b.scale.y.domain();var c=d.pixel(d3.event.dx),g=d.pixel(d3.event.dy);b.scale.x.domain([domain_x[0]-c,domain_x[1]-c]);b.scale.y.domain([domain_y[0]+g,domain_y[1]+g]);b.drawFast();b.debug&&(b.debug.data.time.drag=d.elapsed_time(a))}).on("end",
function(){b.drawFull()});d3.select(b.canvas.node("ui")).call(b._drag)}})(CGView);
(function(d){d.Viewer.prototype._updateZoomMax=function(){this._zoom&&this._zoom.scaleExtent([.8,this.backbone.maxZoomFactor()])};d.Viewer.prototype.initializeZooming=function(){var b=this,a=this.backbone.maxZoomFactor();b._zoom=d3.zoom().scaleExtent([1,a]).on("start",function(){}).on("zoom",function(){var a=(new Date).getTime(),g=d3.mouse(b.canvas.node("ui")),f=b.scale.x.invert(d.pixel(g[0])),e=b.scale.y.invert(d.pixel(g[1])),g=b.backbone.zoomedRadius,e=d.angleFromPosition(f,e);b._zoomFactor=d3.event.transform.k;
var g=g-b.backbone.zoomedRadius,f=d.pixel(Math.cos(-e)*g),g=d.pixel(Math.sin(-e)*g),e=b.scale.x.domain(),h=b.scale.y.domain();b.scale.x.domain([e[0]-f,e[1]-f]);b.scale.y.domain([h[0]-g,h[1]-g]);b.drawFast();b.debug&&(b.debug.data.time&&(b.debug.data.time.zoom=d.elapsed_time(a)),b.debug.data.zoom&&(b.debug.data.zoom.scale=d.round(b._zoomFactor,1)))}).on("end",function(){b.drawFull()});d3.select(b.canvas.node("ui")).call(b._zoom).on("dblclick.zoom",null)}})(CGView);
...
extractStartStopCodons=function(b,a,c){c=void 0===c?{}:c;var d=0,f=0,e=1==b?a.seqString:reverseComplement(a.seqString),h=a.startPattern.toUpperCase().split(",").map(function(a){return a.trim()}).join("|");a=a.stopPattern.toUpperCase().split(",").map(function(a){return a.trim()}).join("|");var k=h+"|"+a,h=h.split("|");a=a.split("|");for(var k=new RegExp(k,"g"),l,m,n,p=e.length,q=[];null!=(l=k.exec(e));)d=1==b?l.index+1:p-l.index-l[0].length+1,0<=h.indexOf(l[0])?n="start-codon":0<=a.indexOf(l[0])&&
(n="stop-codon"),m={type:n,start:d,stop:d+l[0].length-1,strand:b,source:"start-stop-codons",extractedFromSequence:!0},q.push(m),d=Math.round(1==b?d/p*100:(p-d)/p*100),f=postProgress(d,f,c),k.lastIndex=l.index+1;return q};postProgress=function(b,a,c){c=void 0===c?{}:c;var d=c.start||0,f=c.increment||1;c=(c.stop||100)-d;b>a&&0==b%f&&(a=b,b=d+c*b/100,0==b%f&&postMessage({messageType:"progress",progress:b}));return a};extractORFs=function(b){var a=b.minORFLength,c=b.seqString.length,d=[],f={start:0,stop:25},
d=extractStartStopCodons(1,b,f),f={start:25,stop:50},d=d.concat(extractStartStopCodons(-1,b,f)),f=d.filter(function(a){return"start-codon"==a.type}),d=d.filter(function(a){return"stop-codon"==a.type});b=featuresByReadingFrame(f,c);var e=featuresByReadingFrame(d,c),f={start:50,stop:75},d=orfsByStrand(1,b,e,a,c,f),f={start:75,stop:100};return d=d.concat(orfsByStrand(-1,b,e,a,c,f))};orfsByStrand=function(b,a,c,d,f,e){e=void 0===e?{}:e;var h,k,l,m,n,p,q,r,t,x=[],z=1==b?["rf_plus_1","rf_plus_2","rf_plus_3"]:
["rf_minus_1","rf_minus_2","rf_minus_3"];z.forEach(function(u){h=1==b?1:f;q=0;l=a[u];m=c[u];progressInitial=33*z.indexOf(u);t=r=0;-1==b&&(l.sort(function(a,b){return b.start-a.start}),m.sort(function(a,b){return b.start-a.start}));for(var v=0,y=l.length;v<y;v++)if(n=l[v],r=progressInitial+Math.round(v/y*33),t=postProgress(r,t,e),!(1==b&&n.start<h||-1==b&&n.start>h))for(var w=q,A=c[u].length;w<A;w++)if(p=m[w],k=1==b?p.stop-n.start:n.stop-p.start,k>=d){h=1==b?p.stop:p.start;featureData={type:"ORF",
...
rf_plus_2:[],rf_plus_3:[],rf_minus_1:[],rf_minus_2:[],rf_minus_3:[]},d,f,e=0,h=b.length;e<h;e++)f=b[e],-1==f.strand?(d=(a-f.stop+1)%3,0==d&&(d=3),c["rf_minus_"+d].push(f)):(d=f.start%3,0==d&&(d=3),c["rf_plus_"+d].push(f));return c}}})(CGView);
(function(d){d.WorkerBaseContent=function(){onmessage=function(b){console.log("Starting "+b.data.type);calculateBaseContent(b.data);console.log("Done "+b.data.type)};onerror=function(b){console.error("Oops. Problem with "+b.data.type)};calculateBaseContent=function(b){var a=0,c=0,d=[],f=[],e=b.type,h=b.seqString,k=b.window,l=b.step;b=b.deviation;for(var m=baseCalculation(e,h),n=1,p=0,k=k/2,q,r=1,t=h.length;r<t;r+=l)a=subtractBp(h,r,k),q=addBp(h,r,k),a=subSequence(h,a,q),a=baseCalculation(e,a),a>p&&
(p=a),a<n&&(n=a),1==r?d.push(1):d.push(r-l/2),f.push(a),a=Math.round(r/t*100),a>c&&0==a%1&&(c=a,postMessage({messageType:"progress",progress:a}));"scale"==b&&(f=f.map(function(a){return a>=m?scaleValue(a,{min:m,max:p},{min:.5,max:1}):scaleValue(a,{min:n,max:m},{min:0,max:.5})}),n=0,p=1,m=.5);postMessage({messageType:"complete",baseContent:{positions:d,scores:f,min:n,max:p,average:m}})};baseCalculation=function(b,a){if("gc_content"==b)return calcGCContent(a);if("gc_skew"==b)return calcGCSkew(a)};calcGCContent=
