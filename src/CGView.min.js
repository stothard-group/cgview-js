...
-l*Math.sin(m),p=[b[0],b[1],e[0],e[1]],q=[n-h,n+h,l+k,l-k];d3.select(this.canvas.node).transition().duration(c).tween("move",function(){var a=d3.interpolateArray(p,q);return function(c){f.scale.x.domain([a(c)[0],a(c)[1]]);f.scale.y.domain([a(c)[2],a(c)[3]]);f.drawFast()}}).on("end",function(){f.drawFull()})};b.prototype.getCurrentBp=function(){var a=this.scale.x.domain(),c=this.scale.y.domain();return this.canvas.bpForPoint({x:(a[1]-a[0])/2+a[0],y:(c[1]-c[0])/2+c[0]})};b.prototype.moveCaption=function(a,
c){this._captions.move(a,c);this.refreshCaptions()};b.prototype.on=function(a,c){this.events.on(a,c)};b.prototype.off=function(a,c){this.events.off(a,c)};b.prototype.trigger=function(a,c){this.events.trigger(a,c)};Object.defineProperties(b.prototype,{width:{configurable:!0,enumerable:!0,get:function(){return this._width},set:function(a){this.resize(a)}},height:{configurable:!0,enumerable:!0,get:function(){return this._height},set:function(a){this.resize(null,a)}},minDimension:{configurable:!0,enumerable:!0,
get:function(){return Math.min(this.height,this.width)}},zoomFactor:{configurable:!0,enumerable:!0,get:function(){return this._zoomFactor},set:function(a){this._zoomFactor=a}},scale:{configurable:!0,enumerable:!0,get:function(){return this.canvas.scale}},colorPicker:{configurable:!0,enumerable:!0,get:function(){if(void 0==this._colorPicker){var a=this.containerId+"-color-picker";this._container.append("div").classed("cp-color-picker-dialog",!0).attr("id",this.containerId+"-color-picker");this._colorPicker=
new d.ColorPicker(a)}return this._colorPicker}},debug:{configurable:!0,enumerable:!0,get:function(){return this._debug},set:function(a){a?(!0===a&&(a={},a.sections=b.debug_sections),this._debug=new d.Debug(a)):this._debug=void 0}},sequence:{configurable:!0,enumerable:!0,get:function(){return this._sequence}}});Object.defineProperties(b,{debug_sections:{configurable:!0,enumerable:!0,get:function(){return["time","zoom","position","n"]}}});d.Viewer=b})(CGView);
...
this.parent;if("left"==this.textAlignment)return a.originX+a.padding;if("center"==this.textAlignment)return a.originX+a.width/2;if("right"==this.textAlignment)return a.originX+a.width-a.padding};b.prototype.textY=function(){var a=this.parent,c=a.originY+a.padding;a._items.indexOf(this);for(var b=0,g=a._items.length;b<g;b++){var d=a._items[b];if(d==this)break;d.visible&&(c+=1.5*d.height)}return c};b.prototype.highlight=function(a){this.visible&&this.parent.visible&&(a=this.canvas.context("ui"),a.lineWidth=
...
Object.keys(a),g=b.length,d=0,h=this.length;d<h;d++)for(var k=0;k<g;k++)this[d][b[k]]=a[b[k]];else if(2==arguments.length)for(b=0,g=this.length;b<g;b++)this[b][arguments[0]]=arguments[1];else if(void 0!=a)throw Error("attr(): must be 2 arguments or a single object");return this};a.prototype.draw=function(a,b,g,d,h){for(var k=0,l=this.length;k<l;k++)this[k].draw(a,b,g,d,h);return this};a.prototype.each=function(a){for(var b=0,g=this.length;b<g;b++)a.call(this[b],b,this[b]);return this};a.prototype.eachFromRange=
