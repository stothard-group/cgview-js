...
function(a,c){c=void 0===c?"arc":c;var f=this.findFeatureTypeByName(a);f||(f=new d.FeatureType(this,{name:a,decoration:c}));return f};b.prototype.refreshCaptions=function(){for(var a=0,c=this._captions.length;a<c;a++)this._captions[a].refresh();this.legend.refresh()};b.prototype.moveTo=function(a,c,f){c=void 0===c?1E3:c;var b=this;f=f||d3.easeCubic;var e=this.scale.x.domain(),h=this.scale.y.domain(),k=Math.abs(e[1]-e[0])/2,l=Math.abs(h[1]-h[0])/2,m=d.pixel(this.backbone.zoomedRadius),n=this.scale.bp(a);
a=m*Math.cos(n);var m=-m*Math.sin(n),p=[e[0],e[1],h[0],h[1]],q=[a-k,a+k,m+l,m-l];d3.select(this.canvas.node("ui")).transition().duration(c).ease(f).tween("move",function(){var a=d3.interpolateArray(p,q);return function(c){b.scale.x.domain([a(c)[0],a(c)[1]]);b.scale.y.domain([a(c)[2],a(c)[3]]);b.drawFast()}}).on("end",function(){b.drawFull()})};b.prototype.zoomTo=function(a,c,f,b){f=void 0===f?1E3:f;var e=this;b=b||d3.easeCubic;var h=e._zoom.scaleExtent();c=d.constrain(c,h[0],h[1]);var h=this.scale.x.domain(),
k=this.scale.y.domain(),l=this.scale.x.range()[1]/2,m=this.scale.y.range()[1]/2,n=d.pixel(this.backbone.radius*c),p=this.scale.bp(a);a?(a=n*Math.cos(p),n=-n*Math.sin(p)):n=a=0;var q=[h[0],h[1],k[0],k[1]],r=[a-l,a+l,n+m,n-m];d3.select(this.canvas.node("ui")).transition().duration(f).ease(b).tween("move",function(){var a=d3.interpolateArray(q,r),f=d3.interpolate(e._zoomFactor,c);return function(c){e.scale.x.domain([a(c)[0],a(c)[1]]);e.scale.y.domain([a(c)[2],a(c)[3]]);e._zoomFactor=f(c);d3.zoomTransform(e.canvas.node("ui")).k=
f(c);e.drawFast()}}).on("end",function(){e.drawFull()})};b.prototype.reset=function(a,c){this.zoomTo(0,1,void 0===a?1E3:a,c)};b.prototype.getCurrentBp=function(){var a=this.scale.x.domain(),c=this.scale.y.domain();return this.canvas.bpForPoint({x:(a[1]-a[0])/2+a[0],y:(c[1]-c[0])/2+c[0]})};b.prototype.moveCaption=function(a,c){this._captions.move(a,c);this.refreshCaptions()};b.prototype.on=function(a,c){this.events.on(a,c)};b.prototype.off=function(a,c){this.events.off(a,c)};b.prototype.trigger=function(a,
c){this.events.trigger(a,c)};Object.defineProperties(b.prototype,{width:{configurable:!0,enumerable:!0,get:function(){return this._width},set:function(a){this.resize(a)}},height:{configurable:!0,enumerable:!0,get:function(){return this._height},set:function(a){this.resize(null,a)}},minDimension:{configurable:!0,enumerable:!0,get:function(){return Math.min(this.height,this.width)}},zoomFactor:{configurable:!0,enumerable:!0,get:function(){return this._zoomFactor},set:function(a){this._zoomFactor=a}},
scale:{configurable:!0,enumerable:!0,get:function(){return this.canvas.scale}},colorPicker:{configurable:!0,enumerable:!0,get:function(){if(void 0==this._colorPicker){var a=this.containerId+"-color-picker";this._container.append("div").classed("cp-color-picker-dialog",!0).attr("id",this.containerId+"-color-picker");this._colorPicker=new d.ColorPicker(a)}return this._colorPicker}},debug:{configurable:!0,enumerable:!0,get:function(){return this._debug},set:function(a){a?(!0===a&&(a={},a.sections=b.debug_sections),
this._debug=new d.Debug(a)):this._debug=void 0}},sequence:{configurable:!0,enumerable:!0,get:function(){return this._sequence}}});Object.defineProperties(b,{debug_sections:{configurable:!0,enumerable:!0,get:function(){return["time","zoom","position","n"]}}});d.Viewer=b})(CGView);
...
[];else{var c=this.start,b=this.end,d=this.sublist;this.intervals=a=this._normalize(a);a.sort(function(a,d){return c(a)!=c(d)?c(a)-c(d):b(d)-b(a)});var e=[],h=[];this.topList=h;h.push(a[0]);if(1!=a.length)for(var k,l,m=1,n=a.length;m<n;m++)if(k=a[m],b(k)<b(a[m-1]))e.push(h),h=Array(k),d(a[m-1],h);else for(;;)if(0==e.length){h.push(k);break}else if(l=e[e.length-1],b(l[l.length-1])>b(k)){h.push(k);break}else h=e.pop()}};b.prototype.end=function(a){return a.stop||a.interval.stop};b.prototype.start=function(a){return a.start||
