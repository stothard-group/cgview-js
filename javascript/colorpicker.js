...
(function(window, document, undefined) {
    ...
    function ColorPicker(slideElement, pickerElement, alphaElement, callback) {
        ...
        d3.select(this.slideElement).on('mousedown.click', slideListener(this, this.slideElement, this.pickerElement));
        // addEventListener(this.pickerElement, 'click', pickerListener(this, this.pickerElement));
        d3.select(this.pickerElement).on('mousedown.click', pickerListener(this, this.pickerElement));
